...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Dialogos)
/* harmony export */ });
/* harmony import */ var _modelos_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modelos.js */ "./src/js/modelos.js");
...
class Dialogos {
    ...
    mostrarFormularioTarea(contenedor, idLista, idTarea, oldTarea) {
        ...
        fechaBox.valueAsDate = oldTarea.fecha ? (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(oldTarea.fecha, 'dd/MM/yyyy', new Date()) : new Date();
        ...
        addButton.addEventListener('click', (event) => {
            ...
            event.preventDefault()
            const item = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, taskBox.value)
            lista.push(item)
        ...
        aceptar.addEventListener('click', (event) => {
            ...
            var newTarea = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Tarea(tituloBox.value, prioridad, (0,date_fns__WEBPACK_IMPORTED_MODULE_2__["default"])(new Date(fechaBox.value), 'dd/MM/yyyy'), descripcionArea.value, lista)
            this.screen.removeDialogo(contenedor, form, idDialogo)
