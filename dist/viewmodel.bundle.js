...
/* harmony export */   "getSamples": () => (/* binding */ getSamples)
/* harmony export */ });
...
class ViewModel {
    ...
    addLista() {
        this.listas.push(new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Lista("", []))
...
function getSamples() {
    ...
    var check111 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Estudiar tema")
    var check112 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Desarrollar interfaz")
    var check113 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Implementar funcionalidades")
    var check114 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Desplegar en GitHub Pages")
    checklist11.push(check111)
    checklist11.push(check112)
    checklist11.push(check113)
    checklist11.push(check114)

    var tarea11 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Tarea("Hacer app de lista de tareas", "alta", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(2022, 3, 31), 'dd/MM/yyyy'), "Desarrollar una app web de gestión de listas de tareas", checklist11)
    tareas1.push(tarea11)
    //

    const checklist12 = []
    var check121 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Desarrollar interfaz")
    var check122 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Implementar funcionalidades")
    var check123 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Realizar tests")
    var check124 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Desplegar app")
    checklist12.push(check121)
    checklist12.push(check122)
    checklist12.push(check123)
    checklist12.push(check124)

    var tarea12 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Tarea("Juego de Hundir la flota", "media", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(2022, 4, 6), 'dd/MM/yyyy'), "Crear juego online de hundir la flota.", checklist12)
    tareas1.push(tarea12)
    //

    const lista1 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Lista("Teralco", tareas1)
    listas.push(lista1)
    ...
    var check211 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Hacer la cama")
    var check212 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Limpiar el polvo")
    var check213 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Barrer y fregar")
    checklist21.push(check211)
    checklist21.push(check212)
    checklist21.push(check213)

    var tarea21 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Tarea("Limpiar la habitacion", "baja", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(2022, 4, 1), 'dd/MM/yyyy'), "Guardar todo debajo de la alfombra.", checklist21)
    tareas2.push(tarea21)
    //

    const checklist22 = []
    var check221 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Espaguetis")
    var check222 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Pimientos")
    var check223 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Cebollas")
    var check224 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Tomate frito")
    var check225 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Carne picada")
    var check226 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Chocolate")
    var check227 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Pan")
    ...
    var tarea22 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Tarea("Hacer la compra", "media", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(2022, 4, 3), 'dd/MM/yyyy'), "Comprar lo necesario para la semana.", checklist22)
    tareas2.push(tarea22)
    //

    const checklist23 = []
    var check231 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Hacer la compra de la comida")
    var check232 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Cortar y lavar la verdura")
    var check233 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(true, "Hervir la pasta")
    var check234 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Hacer el sofrito")
    var check235 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Mezclar todo en la sartén")
    var check236 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.CheckItem(false, "Servir y saborear")
    ...
    var tarea23 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Tarea("Cocinar algo delicioso", "alta", (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(2022, 4, 2), 'dd/MM/yyyy'), "Hacer espaguetis a la boloñesa.", checklist23)
    tareas2.push(tarea23)
    //

    const lista2 = new _modelos_js__WEBPACK_IMPORTED_MODULE_0__.Lista("Casa", tareas2)
